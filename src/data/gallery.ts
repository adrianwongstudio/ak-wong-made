export type GalleryItem = {
  ...
  caption: string;
  project: string;
  services: ('Automation' | 'Website' | 'Web App')[];
};
...
export const gallery: GalleryItem[] = [
  ...
  { src: '/gallery/placeholder-3.svg', alt: 'Invoice automation dashboard', caption: 'Invoice → Receipt',           project: 'Invoicing', services: ['Automation'] },
  ...
  { src: '/gallery/placeholder-6.svg', alt: 'Agent orchestration',          caption: 'Agent Orchestration',         project: 'Agents',    services: ['Automation'] },
];
